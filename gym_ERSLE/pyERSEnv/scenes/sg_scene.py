...
class SgScene(gymGame.Scene):
    ...
    def reset(self):
        ...
        # type: gymGame.GameObject
        mapRG_GO = self.instantiate(
            gym_ERSLE.pyERSEnv.MapRequestsGeneratorPrefab)
        mapRG = mapRG_GO.getComponent(
            gym_ERSLE.pyERSEnv.MapBasedRequestGenerator)  # type: gym_ERSLE.pyERSEnv.MapBasedRequestGenerator
        mapRG.rph_maps = gym_ERSLE.pyERSEnv.singapore_rph_maps
        mapRG.width, mapRG.height = self.fov[0], self.fov[1]
        ...
        gymGame.set_execution_order([
            ...
            gym_ERSLE.pyERSEnv.MapBasedRequestGenerator,
